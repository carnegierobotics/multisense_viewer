...
if (NOT EXISTS "${PROJECT_SOURCE_DIR}/${IMGUI_DIR}/imgui.h")
    ...
    set(IMGUI_DIR external/imgui)
    include_directories(../src/Viewer/VkRender/ImGui/Custom) # Custom IMGUI application
    ...
    set(IMGUI_SRC
            ...
            src/Viewer/VkRender/ImGui/Custom/imgui_user.h)
...
if (NOT EXISTS "${PROJECT_SOURCE_DIR}/${KTX_DIR}/CMakeLists.txt")
    ...
    message(STATUS "[VkRenderINFO]: Adding KTX from directory: ${KTX_DIR}")
