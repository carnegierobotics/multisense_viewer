...
namespace VkRender {
    ...
    public:
        ...
        void addPopup(GuiObjectHandles& uiContext) {
            ...
            if (ImGui::BeginPopupModal("add_device_modal", nullptr,
                ...
                if (btnConnect) {
                    ...
                    m_context->multiSense()->addNewProfile(profileInfo);
                    uiContext.shared->openAddDevicePopup = false;
                    ImGui::CloseCurrentPopup();
                }
        ...
        void onUIRender(VkRender::GuiObjectHandles& handles) override {
            ...
            ImVec2 window_size = ImVec2(handles.info->applicationWidth, handles.info->applicationHeight - window_pos.y); // Size (width, height)
