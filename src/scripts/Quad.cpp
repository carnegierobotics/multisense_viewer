...
void Quad::setup() {
    ...
    model->prepareTextureImage(width, height, width * height); // TODO TEMP-remove it
...
void Quad::update() {
    ...
    if (camera->modeChange) {
        ...
        model->prepareTextureImage(imgConf.width(), imgConf.height(), imgConf.width() * imgConf.height()); // TODO TEMP-remove it
