...
def write_bag_file(bag_path, image_paths, left_camera_info, right_camera_info):
...
def main(root_images_directory, output_bag_file, topic_prefix):
    ...
    left_camera_info, right_camera_info = get_camera_info(root_images_directory)

    write_bag_file(output_bag_file, image_paths, left_camera_info, right_camera_info)
