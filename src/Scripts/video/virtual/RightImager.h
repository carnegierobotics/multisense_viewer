...
#ifndef MULTISENSE_VIEWER_RIGHTIMAGER_H
#define MULTISENSE_VIEWER_RIGHTIMAGER_H
...
class RightImager : public Base, public RegisteredInFactory<RightImager>, CRLCameraModels {
...
public:
    ...
    static std::unique_ptr<Base> CreateMethod() { return std::make_unique<RightImager>(); }

    /** @brief Name which is registered for this class. Same as ClassName **/
    static std::string GetFactoryName() { return "RightImager"; }
...
#endif //MULTISENSE_VIEWER_RIGHTIMAGER_H
