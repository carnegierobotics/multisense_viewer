...
void RightImager::transformToUISpace(MultiSense::GuiObjectHandles uiHandle, MultiSense::Device dev) {
...
void RightImager::draw(VkCommandBuffer commandBuffer, uint32_t i, bool b) {
